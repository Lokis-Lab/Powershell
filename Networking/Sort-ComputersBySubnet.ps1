...
# --- Export results
if (-not $sortedComputers -or @($sortedComputers).Count -eq 0) {
  throw "No computers with parseable IP addresses were found. Prior export at '$OutputFile' was preserved."
}
